  ...
  <Card title="UI Components — with Props & Usage">
    ...
    {[
      ...
      {name:'FamilySelector', file:'FamilySelector.jsx',
       ...
       desc: "Renders 'Who is eating tonight' chip selector above the Generate button. Only visible when user has family members saved in Profile.Each chip shows member name and dietary icon (veg/non-veg/jain etc). Selecting a member restricts recipe generation to their dietary profile.",
