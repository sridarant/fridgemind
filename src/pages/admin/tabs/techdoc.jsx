  ...
  <Card title="UI Components — with Props & Usage">
    ...
    {[
      ...
      {name:'FamilySelector', file:'FamilySelector.jsx',
       ...
       desc:'Renders the Family chip selector above the Generate button. Only visible when user has family members saved in Profile. Each chip shows member name and dietary icon. Selecting a member restricts recipe generation to their dietary profile.',
